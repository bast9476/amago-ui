...
export default function ReviewFlightHeader() {
        ...
        <View className="h-[58px] flex-row items-center justify-between px-4">
          ...
          >
            <Svg width={18} height={18} viewBox="0 0 18 18" fill="none">
              <Path
                d="M8.97445 14.2106L3.73926 8.97543L8.97445 3.74023"
                stroke="#242424"
                strokeWidth={1.49577}
                strokeLinecap="round"
          ...
          {/* Title */}
          <Text className="text-base font-semibold text-[#242424]">Flight Review</Text>
          ...
          <View className="flex-row items-center gap-1">
            <TouchableOpacity className="w-9 h-9 items-center justify-center">
              <Svg width={18} height={18} viewBox="0 0 18 18" fill="none">
                ...
                />
                <Path
                  d="M8.90218 16.321C12.9992 16.321 16.3205 12.9997 16.3205 8.90267C16.3205 4.80566 12.9992 1.48438 8.90218 1.48438C4.80517 1.48438 1.48389 4.80566 1.48389 8.90267C1.48389 12.9997 4.80517 16.321 8.90218 16.321Z"
                  stroke="#242424"
                  strokeWidth={1.48366}
                  strokeLinecap="round"
                  strokeLinejoin="round"
