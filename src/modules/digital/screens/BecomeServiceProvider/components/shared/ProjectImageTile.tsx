...
export type ProjectImageTileProps = {
    onPress?: () => void
}

export function ProjectImageTile({ onPress }: ProjectImageTileProps) {
    return (
        <TouchableOpacity
            activeOpacity={0.85}
            onPress={onPress}
            className="w-[85px] h-[85px] rounded-xl bg-[#F3F4F7] items-center justify-center"
        >
